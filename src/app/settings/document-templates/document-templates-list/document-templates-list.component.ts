...
export class DocumentTemplatesListComponent implements OnInit {
  ...
  design!: DxReportDesignerComponent;
  ...
  onDocumentSelected(event: any): void {
    ...
    if (this.selectedDocument) {
      ...
      this.getDesignerModelAction = `ReportDesigner/GetReportDesignerModel?companyId=${this.companyId}&doc_type_id=${this.selectedDocument}&user_id=${this.user_id}`;
      setTimeout(() => {
        this.flag = true;
  ...
  CustomizeMenuActions(event) {
    ...
    if (openAction) openAction.visible = false;
  }
