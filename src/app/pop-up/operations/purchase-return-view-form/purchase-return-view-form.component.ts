...
@Component({
  selector: 'app-purchase-return-view-form',
  templateUrl: './purchase-return-view-form.component.html',
  styleUrls: ['./purchase-return-view-form.component.scss']
})
export class PurchaseReturnViewFormComponent implements OnChanges {
  @Input() formdata: any;
  updatedItems: any[] = [];
  cwidth:any='any';
  supplierList:any;
...
@NgModule({
  ...
  providers: [],
  declarations: [PurchaseReturnViewFormComponent],
  exports: [PurchaseReturnViewFormComponent],
})
export class PurchaseReturnViewFormModule {}
