...
@Component({
  selector: 'app-transfer-out-view-form',
  templateUrl: './transfer-out-view-form.component.html',
  styleUrls: ['./transfer-out-view-form.component.scss']
})
export class TransferOutViewFormComponent {
  @Input() formdata: any;
...
@NgModule({
  ...
  providers: [],
  declarations: [TransferOutViewFormComponent],
  exports: [TransferOutViewFormComponent],
})
export class TransferOutViewFormModule {}
