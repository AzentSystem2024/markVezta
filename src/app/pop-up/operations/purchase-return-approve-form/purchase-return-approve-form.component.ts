...
@Component({
  selector: 'app-purchase-return-approve-form',
  templateUrl: './purchase-return-approve-form.component.html',
  styleUrls: ['./purchase-return-approve-form.component.scss']
})
export class PurchaseReturnApproveFormComponent {
  @Input() formdata: any;
  updatedItems: any[] = [];
  cwidth:any='any';
  supplierList:any;
...
@NgModule({
  ...
  providers: [],
  declarations: [PurchaseReturnApproveFormComponent],
  exports: [PurchaseReturnApproveFormComponent],
})
export class PurchaseReturnApproveFormModule {}
