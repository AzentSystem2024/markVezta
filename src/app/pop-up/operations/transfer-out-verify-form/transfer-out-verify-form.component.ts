...
@Component({
  selector: 'app-transfer-out-verify-form',
  templateUrl: './transfer-out-verify-form.component.html',
  styleUrls: ['./transfer-out-verify-form.component.scss']
})
export class TransferOutVerifyFormComponent {
  @Input() formdata: any;
...
@NgModule({
  ...
  providers: [],
  declarations: [TransferOutVerifyFormComponent],
  exports: [TransferOutVerifyFormComponent],
})
export class TransferOutVerifyFormModule {}
