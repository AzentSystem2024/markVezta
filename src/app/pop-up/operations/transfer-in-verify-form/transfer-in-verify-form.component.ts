...
@Component({
  selector: 'app-transfer-in-verify-form',
  templateUrl: './transfer-in-verify-form.component.html',
  styleUrls: ['./transfer-in-verify-form.component.scss']
})
export class TransferInVerifyFormComponent {
  @Input() formdata: any;
  StoreList:any;
...
@NgModule({
  ...
  providers: [],
  declarations: [TransferInVerifyFormComponent],
  exports: [TransferInVerifyFormComponent],
})
export class TransferInVerifyFormModule {}
