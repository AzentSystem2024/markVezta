...
import { TransferInNewFormComponent } from '../transfer-in-new-form/transfer-in-new-form.component';
import notify from 'devextreme/ui/notify';
import { DataService } from 'src/app/services';

@Component({
  selector: 'app-transfer-in-edit-form',
  templateUrl: './transfer-in-edit-form.component.html',
  styleUrls: ['./transfer-in-edit-form.component.scss']
})
export class TransferInEditFormComponent {
  @Input() formdata: any;
  StoreList:any;
...
@NgModule({
  ...
  providers: [],
  declarations: [TransferInEditFormComponent],
  exports: [TransferInEditFormComponent],
})
export class TransferInEditFormModule {}
