...
@Component({
  selector: 'app-grn-approve-form',
  templateUrl: './grn-approve-form.component.html',
  styleUrls: ['./grn-approve-form.component.scss'],
})
export class GrnApproveFormComponent implements OnInit, OnChanges {
  @Input() formdata: any;
...
@NgModule({
  ...
  providers: [],
  declarations: [GrnApproveFormComponent],
  exports: [GrnApproveFormComponent],
})
export class GrnApproveFormModule {}
