...
@Component({
  selector: 'app-purchase-return-edit-form',
  templateUrl: './purchase-return-edit-form.component.html',
  styleUrls: ['./purchase-return-edit-form.component.scss']
})
export class PurchaseReturnEditFormComponent implements OnChanges{
  @Input() formdata: any;
  updatedItems: any[] = [];
  cwidth:any='any';
  supplierList:any;
...
@NgModule({
  ...
  providers: [],
  declarations: [PurchaseReturnEditFormComponent],
  exports: [PurchaseReturnEditFormComponent],
})
export class PurchaseReturnEditFormModule {}
