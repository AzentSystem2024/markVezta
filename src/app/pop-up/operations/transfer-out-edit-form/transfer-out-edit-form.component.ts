...
@Component({
  selector: 'app-transfer-out-edit-form',
  templateUrl: './transfer-out-edit-form.component.html',
  styleUrls: ['./transfer-out-edit-form.component.scss']
})
export class TransferOutEditFormComponent {
  @Input() formdata: any;
...
@NgModule({
  ...
  providers: [],
  declarations: [TransferOutEditFormComponent],
  exports: [TransferOutEditFormComponent],
})
export class TransferOutEditFormModule {}
