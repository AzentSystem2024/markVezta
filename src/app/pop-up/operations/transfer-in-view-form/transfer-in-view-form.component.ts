...
import { TransferInApproveFormComponent } from '../transfer-in-approve-form/transfer-in-approve-form.component';
import notify from 'devextreme/ui/notify';
import { DataService } from 'src/app/services';

@Component({
  selector: 'app-transfer-in-view-form',
  templateUrl: './transfer-in-view-form.component.html',
  styleUrls: ['./transfer-in-view-form.component.scss']
})
export class TransferInViewFormComponent {
  @Input() formdata: any;
  StoreList:any;
...
@NgModule({
  ...
  providers: [],
  declarations: [TransferInViewFormComponent],
  exports: [TransferInViewFormComponent],
})
export class TransferInViewFormModule {}
