...
@Component({
  selector: 'app-prepayment-gst-add',
  templateUrl: './prepayment-gst-add.component.html',
  styleUrls: ['./prepayment-gst-add.component.scss'],
})
export class PrepaymentGstAddComponent {
  ...
  resetForm() {
    this.PrePaymentFormData = {
      ...
      NO_OF_DAYS: '',
      EXPENSE_AMOUNT: '',
      PREPAY_DETAIL: [{ DUE_DATE: null, DUE_AMOUNT: null }],
    };
...
@NgModule({
  ...
  providers: [],
  declarations: [PrepaymentGstAddComponent],
  exports: [PrepaymentGstAddComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class PrePaymentGstAddModule {}
