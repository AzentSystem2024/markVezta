...
@Component({
  selector: 'app-erp-jv',
  templateUrl: './erp-jv.component.html',
  styleUrls: ['./erp-jv.component.scss'],
})
export class ERPJVComponent {
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (
      ...
      const transformedDetails = (incomingData.DETAILS || []).map(
        (item: any, index: number) => {
          ...
          return {
            ...
            DepartmentGroup: item.DEPARTMENT_GROUP ?? null,
          };
        },
      );
      ...
      this.journalVoucherFormData = {
        ...
        DEPT_ID: incomingData.DEPT_ID ?? null,
...
@NgModule({
  ...
  providers: [],
  declarations: [ERPJVComponent],
  exports: [ERPJVComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class ERPJVModule {}
