...
@Component({
  selector: 'app-delivery-note-form-finance',
  templateUrl: './delivery-note-form-finance.component.html',
  styleUrls: ['./delivery-note-form-finance.component.scss'],
})
export class DeliveryNoteFormFinanceComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.isEditing && this.EditingResponseData) {
      // ✅ EDIT / VIEW MODE
      this.isEditDataAvailable(); // load existing data
    } else {
      // ✅ ADD MODE
...
@NgModule({
  ...
  providers: [],
  declarations: [DeliveryNoteFormFinanceComponent],
