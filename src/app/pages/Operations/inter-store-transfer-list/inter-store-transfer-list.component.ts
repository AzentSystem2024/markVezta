...
import { CUSTOM_ELEMENTS_SCHEMA, ChangeDetectorRef, Component, NgModule, ViewChild } from '@angular/core';
import { BrowserModule } from '@angular/platform-browser';
import { Router } from '@angular/router';
import { DxSelectBoxModule, DxTextAreaModule, DxDateBoxModule, DxFormModule, DxTextBoxModule, DxCheckBoxModule, DxFileUploaderModule, DxDataGridModule, DxButtonModule, DxValidatorModule, DxProgressBarModule, DxTabsModule, DxTemplateModule, DxToolbarModule, DxRadioGroupModule, DxPopupModule, DxTagBoxModule, DxToastModule, DxSwitchModule, DxDataGridComponent, DxDateRangeBoxModule } from 'devextreme-angular';
import { DxoItemModule, DxoLookupModule, DxoFormItemModule } from 'devextreme-angular/ui/nested';
import { FormTextboxModule } from 'src/app/components';
import { DataService } from 'src/app/services';

@Component({
  selector: 'app-inter-store-transfer-list',
  templateUrl: './inter-store-transfer-list.component.html',
  styleUrls: ['./inter-store-transfer-list.component.scss']
})
export class InterStoreTransferListComponent {
  ...
  getTransferList(){
    ...
    if(this.endDate === null){
      ...
      console.log(this.endDate,"startdate")
    }
    this.dataservice.getInterStoreTransferList(userid,this.startDate,this.endDate).subscribe((res:any)=>{
      this.transferList= res.dataa;
    })
  }
  ...
  onExporting(event: any) {
    const fileName = 'Inter-Store-Transfer-List';
...
@NgModule({
  ...
  providers: [],
  exports: [],
  declarations: [InterStoreTransferListComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class InterStoreTransferListModule {}
