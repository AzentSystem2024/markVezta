...
import {
  TransferOutNewFormComponent,
  TransferOutNewFormModule,
} from 'src/app/pop-up/operations/transfer-out-new-form/transfer-out-new-form.component';
import { DataService } from 'src/app/services';
import notify from 'devextreme/ui/notify';
import {
  TransferOutEditFormComponent,
  TransferOutEditFormModule,
} from 'src/app/pop-up/operations/transfer-out-edit-form/transfer-out-edit-form.component';
import {
  TransferOutVerifyFormComponent,
  TransferOutVerifyFormModule,
} from 'src/app/pop-up/operations/transfer-out-verify-form/transfer-out-verify-form.component';
import {
  TransferOutApproveFormComponent,
  TransferOutApproveFormModule,
} from 'src/app/pop-up/operations/transfer-out-approve-form/transfer-out-approve-form.component';
import {
  TransferOutViewFormComponent,
  TransferOutViewFormModule,
} from 'src/app/pop-up/operations/transfer-out-view-form/transfer-out-view-form.component';
@Component({
