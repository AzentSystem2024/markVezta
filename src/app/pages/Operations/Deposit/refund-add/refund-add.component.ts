...
export class RefundAddComponent {
  ...
  onCustomerChanged(event: any): void {
    ...
    this.receiprtFormData.CUSTOMER_ID = selectedId;
  ...
  callAPI(finalPayload: any) {
    this.dataService.insertRefundDeposit(finalPayload).subscribe(
      (response: any) => {
        this.isSaving = false;
        notify(
          {
  ...
  saveReceipt() {
    ...
    const payload = {
      ...
      IS_APPROVED: this.receiprtFormData.IS_APPROVED
    };
    // --- Save data ---
...
@NgModule({
  ...
  providers: [],
  declarations: [RefundAddComponent],
  exports: [RefundAddComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class RefundAddModule { }