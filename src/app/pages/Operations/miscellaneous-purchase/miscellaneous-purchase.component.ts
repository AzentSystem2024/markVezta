...
export class MiscellaneousPurchaseComponent {
  ...
  addButtonOptions = {
    ...
    hint: 'Add new entry',
    onClick: () => {
      this.zone.run(() => this.addMiscPurchase());
    },
  ...
  isAddMiscPurchase: boolean = false;
  creditNotes: any;
  selectedCreditNote: any;
  isEditMiscPurchase: boolean;
  ...
  addMiscPurchase() {
    this.isAddMiscPurchase = true;
    // this.cdr.detectChanges();
  }

  handleClose() {
    this.isAddMiscPurchase = false;
    this.isEditMiscPurchase = false;
