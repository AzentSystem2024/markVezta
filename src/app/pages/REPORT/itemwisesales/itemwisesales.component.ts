...
@Component({
  selector: 'app-itemwisesales',
  templateUrl: './itemwisesales.component.html',
  styleUrls: ['./itemwisesales.component.scss'],
})
export class ItemwisesalesComponent {
  ...
  load_JournalBook_data() {
    const payload = {
      ...
      ITEM_ID: '',
      SALESMAN_ID:
        this.selectedSalesman != null ? String(this.selectedSalesman) : '',
      DEPT_ID:
  ...
  onViewClick(e: any) {
    console.log(e, 'eventinitemwisesale');
...
export class ItemwisesalesModule {}
