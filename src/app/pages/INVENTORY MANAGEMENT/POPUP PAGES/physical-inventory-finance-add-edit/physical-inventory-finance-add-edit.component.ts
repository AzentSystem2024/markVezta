...
@Component({
  selector: 'app-physical-inventory-finance-add-edit',
  templateUrl: './physical-inventory-finance-add-edit.component.html',
  styleUrls: ['./physical-inventory-finance-add-edit.component.scss'],
})
export class PhysicalInventoryFinanceAddEditComponent implements OnInit {
...
@NgModule({
  ...
  providers: [],
  declarations: [PhysicalInventoryFinanceAddEditComponent],
  exports: [PhysicalInventoryFinanceAddEditComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class PhysicalInventoryFinanceAddEditModule {}
