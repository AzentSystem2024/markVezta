...
import { PhysicalInventoryFinanceAddEditModule } from '../POPUP PAGES/physical-inventory-finance-add-edit/physical-inventory-finance-add-edit.component';

@Component({
  selector: 'app-physical-inventory-finance',
  templateUrl: './physical-inventory-finance.component.html',
  styleUrls: ['./physical-inventory-finance.component.scss'],
})
export class PhysicalInventoryFinanceComponent implements OnInit {
...
@NgModule({
  imports: [
    ...
    DxTagBoxModule,
    DxoSummaryModule,
    PhysicalInventoryFinanceAddEditModule,
  ],
  providers: [],
  declarations: [PhysicalInventoryFinanceComponent],
  exports: [PhysicalInventoryFinanceComponent],
