...
@Component({
  selector: 'app-promotion-verify',
  templateUrl: './promotion-verify.component.html',
  styleUrls: ['./promotion-verify.component.scss'],
})
export class PromotionVerifyComponent {
  ...
  convertToIST(date: Date): string {
    ...
    let istOffsetMinutes = 300; // 5 hours * 60 + 30 minutes
    date.setMinutes(date.getUTCMinutes() + istOffsetMinutes);

    // Extract and return time in HH:mm format
  ...
  onSelectionChanged(e) {
    ...
    // console.log(this.selectedSalePrice,this.selectedCost,"price and cost")
  }
  ...
  onAddClick() {
    ...
    if (!this.filteredItems) {
      ...
      console.log(excludedIDs, 'EXCLUDEDIDSSSSSSSSSSSINDUUUUUUUU');
      this.filteredItemStoresListRemaining = this.itemStoresList.filter(
  ...
  AddSelectedItems() {
    ...
    if (this.selectedRowsOfPopup && this.selectedRowsOfPopup.length > 0) {
      ...
      // console.log(this.filteredItems,"INADDSELECT")
      // this.filteredItems = [
      //   ...this.filteredItems,
  ...
  applySelectedValue() {
    if (this.firstDropdownValue === 'cost') {
      ...
      this.selectedRow.forEach((row, index) => {
        ...
        // );
        // console.log(this.valueToUse,"VALUETOUSE")
        // console.log(this.valueToUse,"VALUETOUSE")
      });
  ...
  savePromotion() {
    ...
    if (this.selectedSchemaId) {
      ...
      // console.log(selectedSchema.DESCRIPTION,"SELECTEDSCHEMAAAAAAAAAAAAAAAA")
      ...
      if (selectedSchema) {
        ...
        // console.log('Selected Schema Name111111:', this.selectedSchemaName);
      }
    } else {
  ...
  validateTime(): void {
    if (this.fromTime && this.toTime) {
      const from = new Date(this.fromTime).getTime();
      const to = new Date(this.toTime).getTime();
...
@NgModule({
  ...
  providers: [],
  exports: [PromotionVerifyComponent],
  declarations: [PromotionVerifyComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class PromotionVerifyModule {}
