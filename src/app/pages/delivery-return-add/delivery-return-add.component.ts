...
export class DeliveryReturnAddComponent {
  ...
  saveDeliveryreturn() {
    ...
    const payload = {
      ...
      STORE_ID: Number(this.store_id) || 0,
      DR_DATE: this.DeliveryReturnFormData.DR_DATE,
      REF_NO: this.DeliveryReturnFormData.REF_NO || '',
      CUST_ID: Number(this.customerID) || 0,
      CONTACT_NAME: this.DeliveryReturnFormData.CONTACT_NAME || '',
      CONTACT_PHONE: this.DeliveryReturnFormData.CONTACT_PHONE || '',
      CONTACT_FAX: this.DeliveryReturnFormData.CONTACT_FAX || '',
      CONTACT_MOBILE: this.DeliveryReturnFormData.CONTACT_MOBILE || '',
      SALESMAN_ID: Number(this.DeliveryReturnFormData.SALESMAN_ID) || 0,
      FIN_ID: Number(this.fin_id) || 0,
      TOTAL_QTY: Number(this.DeliveryReturnFormData.TOTAL_QTY) || 0,
      USER_ID: Number(this.user_id) || 0,
      NARRATION: this.DeliveryReturnFormData.NARRATION || '',
      DETAILS: this.DNDatasource.map((d: any) => ({
        SO_DETAIL_ID: Number(d.SO_DETAIL_ID) || 0,
        DN_DETAIL_ID: Number(d.DN_DETAIL_ID) || 0,
        ITEM_ID: Number(d.ITEM_ID) || 0,
        REMARKS: d.REMARKS || '',
        UOM: d.UOM || '',
