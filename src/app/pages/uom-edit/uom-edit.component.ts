...
import { DxButtonModule, DxCheckBoxModule, DxDataGridModule, DxFormModule, DxNumberBoxModule, DxPopupModule, DxSelectBoxModule, DxTextBoxModule, DxValidationGroupModule, DxValidatorModule } from 'devextreme-angular';
...
  }
 ...
 this.formClosed.emit();
  ...
  const isDuplicate = this.uomList?.some(
    (item: any) =>
      item.UOM?.trim().toLowerCase() === uom?.toLowerCase() &&
      item.ID !== id
  );
