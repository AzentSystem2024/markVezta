...
export class CptMasterNewFormComponent implements OnInit {
  ...
  getSubDepartment_DropDown() {
    this.dataService.Get_GropDown('SUB_DEPARTMENT').subscribe((data: any) => {
      this.Subdepartment_DropDownData = data;
    });
  }

  getCostDepartment_DropDown() {
    this.dataService.Get_GropDown('COST_DEPARTMENT').subscribe((data: any) => {
      this.Costdepartment_DropDownData = data;
    });
  }

  getCpt_DropDown() {
    this.dataService.Get_GropDown('CPTTYPE').subscribe((data: any) => {
      this.CptType_DropDownData = data;
    });
  }

  getCostDrive_DropDown() {
    this.dataService.Get_GropDown('COST_DRIVE').subscribe((data: any) => {
      this.CostDrive_DropDownData = data;
    });
  }

  getCostBucket_DropDown() {
    this.dataService.Get_GropDown('COST_BUCKET').subscribe((data: any) => {
      this.CostBucketDataSource = data;
    });
  }

  getClinicianRole_DropDown() {
    this.dataService.Get_GropDown('CLINICIAN_ROLE').subscribe((data: any) => {
  ...
  checkDuplicateCPTCode = (params: any): Promise<boolean> => {
    ...
    return new Promise((resolve) => {
      this.dataService.Get_GropDown('CPT_CODE').subscribe({
        next: (res: any) => {
  ...
  onDepartmentChanged(e: any) {
    ...
    this.dataService
      ...
      .subscribe((res: any) => {
        this.Subdepartment_DropDownData = res;
      });
  }
