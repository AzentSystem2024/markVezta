...
@Component({
  selector: 'app-supplier-fin-list',
  templateUrl: './supplier-fin-list.component.html',
  styleUrls: ['./supplier-fin-list.component.scss']
})
...
@NgModule({
  ...
  providers: [],
  exports: [SupplierFinListComponent],
  declarations: [SupplierFinListComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class SupplierFinListModule { }
