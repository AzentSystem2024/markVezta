...
import { MiscPaymentGstAddModule } from '../misc-payment-gst-add/misc-payment-gst-add.component';
import { MiscPaymentGstEditModule } from '../misc-payment-gst-edit/misc-payment-gst-edit.component';
...
@NgModule({
  ...
  providers: [],
  declarations: [MiscPaymentGstListComponent],
