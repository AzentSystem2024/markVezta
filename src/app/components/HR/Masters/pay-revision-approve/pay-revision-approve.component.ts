...
@Component({
  selector: 'app-pay-revision-approve',
  templateUrl: './pay-revision-approve.component.html',
  styleUrls: ['./pay-revision-approve.component.scss'],
})
export class PayRevisionApproveComponent {
  ...
  onApprove(): void {
    ...
    // Make the API call
    this.dataService.approveSalaryRevision(this.revisionFormData).subscribe(
      (response) => {
        if (response) {
          notify(
            {
...
@NgModule({
  ...
  providers: [],
  declarations: [PayRevisionApproveComponent],
  exports: [PayRevisionApproveComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class PayRevisionApproveModule {}
