...
@Component({
  selector: 'app-production-jv-view',
  templateUrl: './production-jv-view.component.html',
...
@NgModule({
  ...
  providers: [],
  declarations: [ProductionJvViewComponent],
  exports: [ProductionJvViewComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class ProductionJvViewModule {}
